...
class UserMangement(models.Model):
...
class Dummy(models.Model):
    ward_cat=models.ForeignKey(AdmissionWardCate,on_delete=models.CASCADE)

class UserMangement_ward(models.Model):
    user_id=models.CharField(max_length=100)
    user=models.CharField(max_length=100)
    password=models.CharField(max_length=1000)
    ward_cat=models.CharField(max_length=500)

class LabAccess(models.Model):
    user_id=models.CharField(max_length=100)
    user=models.CharField(max_length=100)
    service_department=models.ManyToManyField('testapp.ServiceDepartment')
...
#  karan (18-03-2023)
class UserMangement_Main(models.Model):
    login_id = models.ForeignKey(User,on_delete=models.CASCADE,related_name="login")
    user_id = models.ForeignKey('testapp.CreateUser',on_delete=models.CASCADE,related_name="user_mng")
    screen_access = models.ForeignKey('usermanagementapp.ScreenAccess',on_delete=models.CASCADE,related_name='screen_access_name')
